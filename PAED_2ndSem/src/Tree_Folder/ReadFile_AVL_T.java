...
public class ReadFile_AVL_T {
    ...
    public ReadFile_AVL_T(String Filename) throws IOException {
        ...
        uis = str.split(";");
        tree = new AVLTree();
        tree.superiorNode = new Node_T(Integer.parseInt(uis[0]), uis[1], uis[2], uis[3], Integer.parseInt(uis[4]));
        ...
        for (int i = 0; i < numUsers - 1; i++) {
            ...
            tree.insertNode(Integer.parseInt(uis[0]), uis[1], uis[2], uis[3], Integer.parseInt(uis[4]));
    ...
    public int[] getcoords(){
        int counter = 0;
        int counterV2 = 0;
        int[] returnity = new int[this.numusers];
